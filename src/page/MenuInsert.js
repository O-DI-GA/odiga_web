...
import { postData, postWithFileData } from "../api/Users";
    ...
    menus: [
      {
        name: "떡볶이",
        price: "12,600원",
        img: require("../assets/menuImage/떡볶이.jpg"),
      },
      {
        name: "모둠 튀김",
        price: "5,000원",
        img: require("../assets/menuImage/모둠튀김.jpg"),
      },
    ],
  },
  {
    ...
    menus: [
      {
        name: "에비동",
        price: "12,600원",
        img: require("../assets/menuImage/에비동.jpg"),
      },
      {
        name: "가츠동",
        price: "15,000원",
        img: require("../assets/menuImage/가츠동.jpg"),
      },
      {
        name: "오야코동",
        price: "12,000원",
        img: require("../assets/menuImage/오야꼬동.jpg"),
      },
    ],
  },
];
...
function InsertCategoryModal(props) {
  ...
  const handleAddCategory = async () => {
    const url = `/${props.storeId}/category`;
